...
import '../../../data_model/notification_model/admin_approver_model/money_req_adjustment_model.dart';
...
class MoneyReqAdjustment extends StatefulWidget {
  MoneyReqAdjustment({
  ...
  @override
  State<MoneyReqAdjustment> createState() => _MoneyReqAdjustmentState();
}

class _MoneyReqAdjustmentState extends State<MoneyReqAdjustment> {
  Future<List<MoneyReqAdjustModel>>? futurePost;
  String rejectNote = " ";

  Future<List<MoneyReqAdjustModel>> fetchPost() async {
    var response = await http.post(Uri.parse(ConstApiLink().moneyreqAdjustAPi),
    ...
    if (response.statusCode == 200) {
      ...
      return parsed
          .map<MoneyReqAdjustModel>(
              (json) => MoneyReqAdjustModel.fromJson(json))
          .toList();
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<List<MoneyReqAdjustModel>>(
          future: futurePost,
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                "Total Amount Adjusted:" +
                                    "${snapshot.data![index].xadjamtbal}",
                                textAlign: TextAlign.center,
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                              ...
                              Text(
                                "Remaining money requisition amount:" +
                                    "${snapshot.data![index].xadvrem}",
                                textAlign: TextAlign.center,
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
